...
-(void)BtnAction:(UIButton *)btn{
    ...
    switch (btn.tag) {
        ...
        case 1://收藏按钮
        {
            ...
            //Bmob: 没登录:1.登录 2.取消
            //      已登录:1.收藏动画 2. 同时添加到bmob数组里(保存到沙箱里面)
            
            if ([BmobUser getCurrentUser]==nil){
                
                UIAlertController *ac3 = [UIAlertController alertControllerWithTitle:@"提示" message:@"还没有登陆,不可以收藏哦!" preferredStyle:UIAlertControllerStyleAlert];
                ...
                [self.user.likedJokeArray addObject:self.show];
